...
import com.example.easy_learning.adapter.CourseAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        svCourse = view.findViewById(R.id.sv_course);
        srCourse = view.findViewById(R.id.sr_course);
        layoutLoading = view.findViewById(R.id.layout_loading);
//        fabAdd = view.findViewById(R.id.fab_add);

        svCourse.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
        ...
        srCourse.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
